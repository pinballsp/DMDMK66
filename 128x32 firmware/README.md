...
Insert an empty SD  card (FAT32 formated) in the DMDMK66 SD card socket, connect and start, firmware will create a configure file with default values in your SD card with name DMDMK66.txt. You may edit this file with any text editor.
